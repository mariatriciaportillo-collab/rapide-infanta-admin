              ...
              <div className="w-full md:w-48 shrink-0">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full h-[42px] pl-3 pr-16 border border-slate-300 focus:border-red-500 focus:ring-1 focus:ring-red-500 rounded-md font-bold text-lg text-left bg-white"
                    placeholder="0"
                  />
              ...
              <div className="w-full md:w-48 shrink-0">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full h-[42px] pl-3 pr-16 border border-slate-300 focus:border-green-500 focus:ring-1 focus:ring-green-500 rounded-md font-bold text-lg text-left bg-white"
                    placeholder="0"
                  />
