...
export function EditPartClient({ id }: { id: string }) {
  ...
  if (isLoading) {
    return (
      <div className="max-w-4xl mx-auto py-24 text-center text-slate-500">
        ...
        <p className="text-xl">Loading part details...</p>
      </div>
    )
  }
    ...
    <div className="max-w-4xl mx-auto pb-24">
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-3xl font-bold text-slate-800">Edit Part / Material</h2>
        </div>
      </div>
