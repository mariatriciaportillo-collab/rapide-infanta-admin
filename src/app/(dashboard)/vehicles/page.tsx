  ...
  return (
    <div className="pb-24">
      <div className="flex justify-between items-center mb-6">
        ...
        {/* We generally add vehicles through customers or quotations, but we can have an add button here eventually */}
      </div>
              ...
              {vehicles?.length === 0 ? (
                ...
                vehicles?.map((vehicle) => (
                  <tr key={vehicle.id} className="hover:bg-slate-50 transition">
                    ...
                    <td className="px-6 py-4">
                      {vehicle.customers ? (
                        <Link href={`/customers/${vehicle.customers.id}`} className="font-medium text-blue-600 hover:underline flex items-center gap-2">
