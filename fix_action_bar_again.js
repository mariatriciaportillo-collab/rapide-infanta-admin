  ...
  return (
    <div className="flex items-center border border-slate-300 rounded-md shadow-sm overflow-hidden bg-white">
      ...
      {isDraft ? (
        <button 
          disabled={true}
          className="flex items-center justify-center px-3 py-1.5 text-slate-400 bg-slate-50 border-r border-slate-200 font-medium text-sm gap-2 cursor-not-allowed opacity-60"
        ...
        <>
          <button 
            onClick={handleCompleteJob} // it safely redirects for completed
            disabled={isCompleting}
