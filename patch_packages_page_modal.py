...
# I will just rewrite the ItemsModal part inside it.
# Instead of regex matching, it's easier to just overwrite the file since I generated it entirely.

full_page = """'use client'
