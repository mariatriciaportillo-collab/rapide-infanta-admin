...
content = content.replace(
  /\\`REC-\\\$\{lastPayment\.id\.substring\(0, 8\)\.toUpperCase\(\)\}\\\`/g,
  "`REC-${lastPayment.id.substring(0, 8).toUpperCase()}`"
);

// I should just replace ALL `\` escaped strings in that file with regular backticks.
